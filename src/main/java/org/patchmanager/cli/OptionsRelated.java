...
public class OptionsRelated {
  ...
  public static final Option MVNINSTALL = new Option("m", "mvninstall", false, "Maven install");
  public static final Option FCCREATION = new Option("fcc", "fccreation", false, "FC Creation");
  public static final Option PATCHCREATION = new Option("pc", "patchcreation", false, "Patch Creation");
